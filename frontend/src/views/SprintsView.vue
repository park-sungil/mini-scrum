...
<template>
  <div>
    <div class="flex items-center justify-between mb-8">
      <div>
        <h1 class="font-display text-4xl" style="color: var(--text); font-style: italic">Sprints</h1>
    ...
    <div v-else-if="sprints.length === 0" class="card p-12 text-center">
      <div class="font-display text-2xl mb-2" style="color: var(--text-muted); font-style: italic">No Sprints Yet</div>
    ...
    <div v-else class="space-y-3">
      <div
        ...
        :style="{
          ...
          borderLeft: isCurrentSprint(sprint) ? '3px solid var(--accent)' : ''
        }"
      >
        <div class="flex items-start justify-between">
          <div class="flex-1">
            <div class="flex items-center gap-3 mb-1">
              ...
              <span v-if="isCurrentSprint(sprint)" class="badge" style="background: var(--accent-light); color: var(--accent)">
                진행 중 &middot; {{ getDaysLeft(sprint.end_date) }}일 남음
              </span>
            </div>
      ...
      <div class="modal-content">
        ...
        <form @submit.prevent="saveSprint" class="space-y-4">
          ...
          <div>
            ...
            <textarea v-model="form.goal" rows="3" class="input" placeholder="이번 스프린트의 목표를 작성하세요"></textarea>
          </div>
